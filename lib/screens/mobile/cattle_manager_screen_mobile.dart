...
class CattleManagerScreenMobile extends StatelessWidget {
  const CattleManagerScreenMobile({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    final double iconWidth = screenWidth * 0.07;
    final double listTileFontSize = screenWidth * 0.0016;
    final double iconPopupMenuSize = screenWidth * 0.04;
