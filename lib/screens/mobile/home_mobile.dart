...
import 'package:cattle_track/screens/mobile/cattle_manager_screen_mobile.dart';
import 'package:cattle_track/screens/mobile/cattle_reports_mobile.dart';
...
class _HomePageMobileState extends State<HomePageMobile> {
  ...
  Widget build(BuildContext context) {
    ...
    double buttonTextSize = screenHeight * 0.002;
    double titleSize = screenWidth * 0.003;
    ...
    final List<HomeButton> buttonsList = [
      HomeButton(
          ...
          widget: const CattleManagerScreenMobile()),
      HomeButton(
        name: "Reports",
        iconWidget: SvgPicture.asset(
        ...
        widget: const CattleReportsMobile(),
      ),
    ];
              ...
              Expanded(
                child: GridView.builder(
                  gridDelegate: SliverGridDelegateWithMaxCrossAxisExtent(
                      ...
                      crossAxisSpacing: 16,
                      mainAxisExtent: screenHeight / 2.5,
                      mainAxisSpacing: 16),
